...
function LoadSalePostsWithCount() {
    if (IsHTML5) {
        sessionStorage["CustomerFilters"] = JSON.stringify(filters);
    }
    debugger;
    $("#loader").show();
    $.post("/api/SalePostApi/GetSalePostsWithCount", filters, LoadSalePostsWithCountCallBack);
}
function LoadSalePostsWithCountCallBack(data) {
    debugger;
